...
/**
 * Servlet implementation class cust_add
 */
@WebServlet("/cust_add")
public class cust_add extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    try
	    {
	    	request.setAttribute("i", dao.add_customers(c));
    	    rd=request.getRequestDispatcher("customers_save.jsp");
