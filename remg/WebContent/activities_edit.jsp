		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					...
					String sql="select * from activities WHERE aid='"+aid+"'";
				    Statement stat=conn.createStatement();
				    stat.executeQuery("set names utf8");
				    ResultSet rs=stat.executeQuery(sql);
				    String aname="",begin_time="",end_time="";
				    while(rs.next())
					   {	
				    	   aname=rs.getString("aname");
				    	   begin_time=rs.getString("begin_time").substring(0, 10);
					...
					<div class="col-md-6">
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title">活动信息修改</h3>
							</div>
							<form method="post" class="form-auth-small" action="acti_edit">
								<div class="panel-body">
									<input type="text" class="form-control" placeholder="活动ID" name="aid" value="<%=aid %>" readonly="value">
									<span></span>
									<br>
									<br>
									<input type="text" class="form-control" placeholder="活动名称" name="aname" value="<%=aname%>">
									<span></span>
									<br>
									<br>
									<input type="text" class="form-control" placeholder="开始时间" name="begin_time" value="<%=begin_time%>">
									<span></span>
									<br>
									<br>
									<input type="text" class="form-control" placeholder="结束时间" name="end_time" value="<%=end_time%>">
									<span></span>
									<br>
									<br>
									<a href="javascript:;"><button type="submit" class="btn btn-primary btn-lg btn-block">确定</button></a>
									<br>
									<button onclick="javascript:window.location.href='acti_main'" type="button" class="btn btn-warning btn-lg btn-block">返回</button>
								</div>
							</form>
						</div>
					</div>
