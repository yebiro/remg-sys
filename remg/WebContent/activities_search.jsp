						...
						<div class="panel-body">
							<table>
								<tr>
									...
									<td><a href="acti_main"><button type="button" class="btn btn-success btn-toastr" data-context="success">返回</button></a></td>
								</tr>
							</table>
						</div>
					</div>
						...
						<table class="table">
							...
							<tbody>
								<tr>
									...
									<td><%=end_time%></td>
									<td>
										<a href="acti_edit?cid=<%=aid %>"><span class="lnr lnr-pencil"></span></a>
										<img src="assets/img/little_blank_1.png">
										<a href="acti_del?cid=<%=aid %>" onclick="return del()"><span class="lnr lnr-trash"></span></a>
									</td>
								</tr>
							</tbody>
						</table>
