<%@page language="java" import="java.util.*,java.sql.*,java.net.*,bean.orders" contentType="text/html; charset=utf8"
    pageEncoding="utf8"%>
<!doctype html>
<html lang="en">
<% 
					...
					<div class="panel panel-headline">
						<div class="panel-body">
							<table>
								<tr>
									<td>以下为查询结果：</td>
									<td><img src="assets/img/blank.png"></td>
									<td><a href="order_main"><button type="button" class="btn btn-success btn-toastr" data-context="success">返回</button></a></td>
								</tr>
							</table>
						</div>
					</div>
						...
						<table class="table">
							...
							<tbody>
								<tr>
									...
									<td><%=staname%></td>
									<td>
										<a href="orders_del.jsp?oid=<%=oid%>" onclick="return del()"><span class="lnr lnr-trash"></span></a>
									</td>
									<%
								    if(staname.equals("配餐中")){
								    %>
								    <td>
										<a href="orders_state.jsp?oid=<?jsp echo $oid; ?>"><span class="label label-success">完成</span></a>
