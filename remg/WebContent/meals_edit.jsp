			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="meal_main" class="active"><i class="lnr lnr-dinner"></i> <span>套餐管理</span></a></li>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					...
					String sql="select * from meals WHERE mid='"+mid+"'";
				    Statement stat=conn.createStatement();
				    stat.executeQuery("set names utf8");
				    ResultSet rs=stat.executeQuery(sql);
				    String mname="",mprice="",meal_integral="",qoh="",qoh_threshold="";
				    while(rs.next())
					   {	
				    	   mname=rs.getString("mname");
				    	   mprice=rs.getString("mprice");
				    	   meal_integral=rs.getString("meal_integral");
				    	   qoh=rs.getString("qoh");
				    	   qoh_threshold=rs.getString("qoh_threshold");
					   }
					%>	
					...
					<div class="col-md-6">
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title">套餐信息修改</h3>
							</div>
							<form method="post" class="form-auth-small" action="meal_edit">
								<div class="panel-body">
									<input type="text" class="form-control" placeholder="套餐ID" name="mid" value="<%=mid%>" readonly="value">
									<span></span>
									<br>
									<br>
									<input type="text" class="form-control" placeholder="套餐名称" name="mname" value="<%=mname%>">
									<span></span>
									<br>
									<br>
									<input type="text" class="form-control" placeholder="套餐价格" name="mprice" value="<%=mprice%>">
									<span></span>
									<br>
									<br>
									<input type="text" class="form-control" placeholder="套餐对应积分" name="meal_integral" value="<%=meal_integral%>">
									<span></span>
									<br>
									<br>
									<input type="text" class="form-control" placeholder="份数" name="qoh" value="<%=qoh%>">
									<span></span>
									<br>
									<br>
									<input type="text" class="form-control" placeholder="数量阈值" name="qoh_threshold" value="<%=qoh_threshold%>">
									<br>
									<br>
									<!-- <input type="text" class="form-control" value="regular" name="level">
									<br>
									<br> -->
									<a href="javascript:;"><button type="submit" class="btn btn-primary btn-lg btn-block">确定</button></a>
									<br>
									<button onclick="javascript:window.location.href='meal_main'" type="button" class="btn btn-warning btn-lg btn-block">返回</button>
								</div>
							</form>
						</div>
					</div>
