				...
				<div class="container-fluid">
					<div class="col-md-6">
						<div class="panel">
							...
							<form method="post" class="form-auth-small" action="acti_add">
								<div class="panel-body">
									<input type="text" class="form-control" placeholder="活动ID" name="aid">
									<span></span>
									<br>
									<br>
									<input type="text" class="form-control" placeholder="活动名称" name="aname">
									<span></span>
									<br>
									<br>
									<input type="text" class="form-control" placeholder="开始时间" name="begin_time">
									<br>
									<br>
