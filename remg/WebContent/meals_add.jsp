				...
				<div class="container-fluid">
					<div class="col-md-6">
						<div class="panel">
							...
							<form method="post" class="form-auth-small" action="meal_add" accept-charset="UTF-8">
								<div class="panel-body">
									<input type="text" class="form-control" placeholder="套餐ID" name="mid">
									<span></span>
									<br>
									<br>
									<input type="text" class="form-control" placeholder="套餐名称" name="mname">
									<span></span>
									<br>
									<br>
									<input type="text" class="form-control" placeholder="套餐价格" name="mprice">
									<span></span>
									<br>
									<br>
									<input type="text" class="form-control" placeholder="套餐对应积分" name="meal_integral">
									<span></span>
									<br>
									<br>
									<input type="text" class="form-control" placeholder="份数" name="qoh">
									<span></span>
									<br>
									<br>
									<input type="text" class="form-control" placeholder="数量阈值" name="qoh_threshold">
									<span></span>
									<br>
									<br>
