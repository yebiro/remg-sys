<%@page language="java" import="java.util.*,java.sql.*,java.net.*,bean.meals" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!doctype html>
<html lang="en">
<% 
						...
						<div class="panel-body">
							<table>
								<tr>
									...
									<td><a href="meal_main"><button type="button" class="btn btn-success btn-toastr" data-context="success">返回</button></a></td>
								</tr>
							</table>
						</div>
					</div>
						...
						<table class="table">
							...
							<tbody>
								<tr>
									...
									<td><%=qoh_threshold%></td>
									<td>
										<a href="meals_edit.jsp?cid=<%=mid %>"><span class="lnr lnr-pencil"></span></a>
										<img src="assets/img/little_blank_1.png">
										<a href="meal_del?cid=<%=mid %>" onclick="return del()"><span class="lnr lnr-trash"></span></a>
									</td>
								</tr>
							</tbody>
						</table>
